  ...
  return (
    <div className="py-20">
      ...
      <form onSubmit={handleSubmit(handleRegister)}>
        ...
        <p className="text-red-500" >Password should be 6 character or longer</p>
      )}
          {errors.password?.type === "pattern" && (
        <p className="text-red-500" >at list 1 uppercase 1 lowercase 1 number and spacial character</p>
      )}
          <input
